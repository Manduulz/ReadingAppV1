                ...
                : Column(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                            fontFamily: 'InterTight', fontSize: 24, fontStyle: FontStyle.normal, fontWeight: FontWeight.w700, color: Colors.black),
                      ),
                        ...
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.all(Radius.circular(10)), borderSide: BorderSide(color: Colors.lightBlueAccent)),
                              hintText: 'Овог',
                              hintStyle: TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50))),
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          style: const TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50)),
                          decoration: const InputDecoration(
                              prefixIcon: Icon(PhosphorIcons.user_circle, color: Color.fromRGBO(0, 124, 214, 0.50)),
                              border: InputBorder.none,
                              filled: true,
                              fillColor: Colors.white,
                              enabledBorder: OutlineInputBorder(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextField(
                                ...
                                style: const TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50)),
                                decoration: const InputDecoration(
                                    prefixIcon: Icon(PhosphorIcons.calendar_blank, color: Color.fromRGBO(0, 124, 214, 0.50)),
                                    border: InputBorder.none,
                                    filled: true,
                                    fillColor: Colors.white,
                                    enabledBorder: OutlineInputBorder(
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          style: const TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50)),
                          decoration: const InputDecoration(
                              prefixIcon: Icon(PhosphorIcons.envelope, color: Color.fromRGBO(0, 124, 214, 0.50)),
                              border: InputBorder.none,
                              filled: true,
                              fillColor: Colors.white,
                              enabledBorder: OutlineInputBorder(
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          style: const TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50)),
                          decoration: const InputDecoration(
                              prefixIcon: Icon(PhosphorIcons.phone, color: Color.fromRGBO(0, 124, 214, 0.50)),
                              border: InputBorder.none,
                              filled: true,
                              fillColor: Colors.white,
                              enabledBorder: OutlineInputBorder(
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          style: const TextStyle(color: Color.fromRGBO(0, 124, 214, 0.50)),
                          decoration: const InputDecoration(
                              prefixIcon: Icon(PhosphorIcons.key, color: Color.fromRGBO(0, 124, 214, 0.50)),
                              border: InputBorder.none,
                              filled: true,
                              fillColor: Colors.white,
                              enabledBorder: OutlineInputBorder(
